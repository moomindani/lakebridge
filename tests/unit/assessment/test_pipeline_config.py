...
@pytest.mark.parametrize(
    ...
    [
        ...
        # No warning: prepare before DDL (prepare runs on source, not counted as early non-DDL)
        ([("prepare1", "prepare", "active"), ("ddl1", "ddl", "active")], False, []),
