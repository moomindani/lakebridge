...
The Lakebridge documentation is built using [Docusaurus](https://docusaurus.io/), a modern static site generator.
...
The markdown files are located in the `docs` directory of the Lakebridge project.
...
1. Clone the Lakebridge repository
2. Run:
...
<div className='bg-gray-100 p-4 rounded-lg'>
  <img src={useBaseUrl('/img/lakebridge-logo.png')} alt="lakebridge" />
</div>
```
