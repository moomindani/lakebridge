...
| native_database_connection_commands | Section containing JDBC/ODBC connection templates for different database types (e.g., `READER_ORACLE`, `WRITER_MSSQL`) | See Native Database Connection Support section |
